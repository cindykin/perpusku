...
public class create_book extends AppCompatActivity {
    ...
    private EditText namaBuku, namaAuthor, sinopsis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambah.setOnClickListener(view -> {
            namaBuku = findViewById(R.id.bookName);
            namaAuthor = findViewById(R.id.authorName);
            sinopsis = findViewById(R.id.bookDescription);

            String judul = namaBuku.getText().toString();
            String author = namaAuthor.getText().toString();
                ...
                if (insertedId != -1) {
                    ...
                    if (imagePath != null) {
                        ...
                        if (updated) {
                            ...
                            Intent intent = new Intent(create_book.this, list_book.class);
                            startActivity(intent);
                        } else {
                            Toast.makeText(create_book.this, "Failed to update image path", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(create_book.this, "Failed to save image", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(create_book.this, "Can't Added Data", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(create_book.this, "Can't add image", Toast.LENGTH_SHORT).show();
            }
        });
    }
